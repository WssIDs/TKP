========================================================================
    ACTIVE TEMPLATE LIBRARY : SRATL4 Project Overview
========================================================================

AppWizard has created this SRATL4 project for you to use as the starting point for
...
SRATL4.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (SRATL4.h)
        GUID definitions                                (SRATL4_i.c)
        A type library                                  (SRATL4.tlb)
        Marshaling code                                 (SRATL4_p.c and dlldata.c)

SRATL4.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in SRATL4.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named SRATL4.pch and a precompiled types file named StdAfx.obj.
...
SRATL4ps.vcxproj
	...
	dlldata.c, SRATL4_i.c and SRATL4_p.c which are required
	to build the proxy/stub DLL.

SRATL4ps.vcxproj.filters
