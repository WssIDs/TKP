========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLLB4 Project Overview
========================================================================

AppWizard has created this ATLLB4 project for you to use as the starting point for
...
ATLLB4.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLLB4.h)
        GUID definitions                                (ATLLB4_i.c)
        A type library                                  (ATLLB4.tlb)
        Marshaling code                                 (ATLLB4_p.c and dlldata.c)

ATLLB4.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLLB4.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLLB4.pch and a precompiled types file named StdAfx.obj.
...
ATLLB4ps.vcxproj
	...
	dlldata.c, ATLLB4_i.c and ATLLB4_p.c which are required
	to build the proxy/stub DLL.

ATLLB4ps.vcxproj.filters
